...
boost::array<std::string, 16> integer_type_names =
{
"bool",
"char",
"unsigned char",
...
boost::array<std::string, 12> float_constant_heads =
{
...
boost::array<std::string, 10> float_function_heads =
{
...
int main()
{
  try
  {
    ...
    using namespace boost::math::fixed_point;
  ...
  // Floating-point
    ...
    typedef boost::math::fixed_point::negatable<32, -16> fp_32m16_type;
    ...
    float_constants<fp_32m16_type>("fixed_point_32,-16", fout);
    fout << "]" "\n";  // end of table;
...
//#endif
      ...
      << "[" << std::numeric_limits<fp_32m16_type >::max() << "]"
      << "]" "\n"; // end of row.
...
//#endif
      ...
      << "[" << std::numeric_limits<fp_32m16_type >::min() << "]"
      << "]" "\n"; // end of row.
...
//#endif
      ...
      << "[" << std::numeric_limits<fp_32m16_type >::epsilon() << "]"
      << "]" "\n"; // end of row.
...
//#endif
      ...
      << "[" << std::numeric_limits<fp_32m16_type >::round_error() << "]"
      << "]" "\n"; // end of row.
...
//#endif
      ...
      << "[" << std::numeric_limits<fp_32m16_type >::infinity() << "]"
      << "]" "\n"; // end of row.
...
//#endif
      ...
      << "[" << std::numeric_limits<fp_32m16_type >::quiet_NaN() << "]"
      << "]" "\n"; // end of row.
