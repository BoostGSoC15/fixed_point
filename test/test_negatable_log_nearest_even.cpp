...
#define BOOST_TEST_MODULE test_negatable_log_nearest_even
...
BOOST_AUTO_TEST_CASE(test_negatable_log_nearest_even)
{
  // Test log() for negatable round::nearest_even in various key digit
  ...
  { typedef boost::fixed_point::negatable< 6,  -17, boost::fixed_point::round::nearest_even> fixed_point_type; local::test_log<fixed_point_type>( 8); }
  { typedef boost::fixed_point::negatable< 8,  -23, boost::fixed_point::round::nearest_even> fixed_point_type; local::test_log<fixed_point_type>( 8); }
  { typedef boost::fixed_point::negatable< 8,  -44, boost::fixed_point::round::nearest_even> fixed_point_type; local::test_log<fixed_point_type>(10); }
  { typedef boost::fixed_point::negatable< 8,  -55, boost::fixed_point::round::nearest_even> fixed_point_type; local::test_log<fixed_point_type>(12); }
  { typedef boost::fixed_point::negatable<12, -100, boost::fixed_point::round::nearest_even> fixed_point_type; local::test_log<fixed_point_type>(14); }
}
