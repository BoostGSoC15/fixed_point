...
//! \file
//!\brief Tests round-trip for fixed_point negatable with 5 decimal digits.

#define BOOST_TEST_MODULE test_negatable_round_trip_digits10_005
...
BOOST_AUTO_TEST_CASE(test_negatable_round_trip_digits10_005)
{
  using local::fixed_point_type;
