...
#define BOOST_TEST_MODULE test_negatable_basic_mixed_constructors_part1
...
BOOST_AUTO_TEST_CASE(test_negatable_basic_mixed_constructors_part1)
{
...
BOOST_AUTO_TEST_CASE(test_negatable_basic_construct_larger_range_smaller_resolution)
{
...
BOOST_AUTO_TEST_CASE(test_negatable_basic_construct_smaller_range_larger_resolution)
{
  // This test uses types which would have the underlying representation as built-in types 
  // and rounding mode is round::fastest. 
  {
