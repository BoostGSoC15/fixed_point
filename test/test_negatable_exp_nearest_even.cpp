...
#define BOOST_TEST_MODULE test_negatable_exp_nearest_even
...
BOOST_AUTO_TEST_CASE(test_negatable_exp_nearest_even)
{
  ...
  { typedef boost::fixed_point::negatable<12,  -12, boost::fixed_point::round::nearest_even> fixed_point_type; local::test_exp<fixed_point_type>( 4); }
  { typedef boost::fixed_point::negatable<12,  -19, boost::fixed_point::round::nearest_even> fixed_point_type; local::test_exp<fixed_point_type>( 6); }
  { typedef boost::fixed_point::negatable<12,  -40, boost::fixed_point::round::nearest_even> fixed_point_type; local::test_exp<fixed_point_type>( 8); }
  { typedef boost::fixed_point::negatable<12,  -51, boost::fixed_point::round::nearest_even> fixed_point_type; local::test_exp<fixed_point_type>(10); }
  { typedef boost::fixed_point::negatable<12, -100, boost::fixed_point::round::nearest_even> fixed_point_type; local::test_exp<fixed_point_type>(12); }
}
