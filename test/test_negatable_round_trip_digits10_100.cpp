...
//! \file
//!\brief Tests round-trip for fixed_point negatable with 100 decimal digits.

#define BOOST_TEST_MODULE test_negatable_round_trip_digits10_100
...
BOOST_AUTO_TEST_CASE(test_negatable_round_trip_digits10_100)
{
  using local::fixed_point_type;
  ...
  BOOST_CONSTEXPR_OR_CONST boost::uint_fast32_t number_of_test_cases = UINT32_C(10000);
