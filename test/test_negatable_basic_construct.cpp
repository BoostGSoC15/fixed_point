...
#define BOOST_TEST_MODULE test_negatable_basic_construct
...
BOOST_AUTO_TEST_CASE(test_negatable_basic_construct_nearest_even_round)
{
...
BOOST_AUTO_TEST_CASE(test_negatable_basic_construct_fastest_round)
{
  //! small range and resolution
  {
