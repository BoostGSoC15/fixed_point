...
#define BOOST_TEST_MODULE test_negatable_func_exp_fastest
...
BOOST_AUTO_TEST_CASE(test_negatable_func_exp_fastest)
{
  // Test exp() for negatable round::fastest in various key digit regions.
  ...
  { typedef boost::fixed_point::negatable< 7,  -24, boost::fixed_point::round::fastest> fixed_point_type; local::test_exp<fixed_point_type>( 6); }
  { typedef boost::fixed_point::negatable<10, -117, boost::fixed_point::round::fastest> fixed_point_type; local::test_exp<fixed_point_type>(12); }
}
