...
typedef boost::fixed_point::negatable<32, -2> fixed_point_type_fastest_round;
typedef boost::fixed_point::negatable<128, -2, boost::fixed_point::round::positive> fixed_point_type_positive_round;
