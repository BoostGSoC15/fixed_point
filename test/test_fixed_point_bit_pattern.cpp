...
BOOST_AUTO_TEST_CASE(fixed_point_construct_nearest_even_round)
{
  ...
  //! larger range and larger resolution
  {
    ...
    fixed_point_type_nearest_even_round x = fixed_point_type_nearest_even_round (cpp_dec_float_100_noet("39614081257132168796771975167.9999999999999999999999999999495129020658552444536493718219016813009147881530225276947021484375"));
    //! max precision + 1/2 ULP
    fixed_point_type_nearest_even_round y = fixed_point_type_nearest_even_round (cpp_dec_float_100_noet("39614081257132168796771975167.999999999999999999999999999962134676549391433340237028866426260975686091114766895771026611328125"));
    ...
    x = fixed_point_type_nearest_even_round (cpp_dec_float_100_noet("-39614081257132168796771975167.9999999999999999999999999999495129020658552444536493718219016813009147881530225276947021484375"));
    //! max precision + 1/2 ULP
    y = fixed_point_type_nearest_even_round (cpp_dec_float_100_noet("-39614081257132168796771975167.999999999999999999999999999962134676549391433340237028866426260975686091114766895771026611328125"));
