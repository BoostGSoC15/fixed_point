...
#define BOOST_TEST_MODULE test_negatable_mixed_constructors_part2
...
BOOST_AUTO_TEST_CASE(test_negatable_mixed_constructors_part2)
{
...
BOOST_AUTO_TEST_CASE(test_negatable_construct_larger_range_larger_resolution)
{
