...
//! \file
//!\brief Tests round-trip for fixed_point negatable with 3 decimal digits.

#define BOOST_TEST_MODULE test_negatable_round_trip_digits10_003
...
BOOST_AUTO_TEST_CASE(test_negatable_round_trip_digits10_003)
{
  typedef local::fixed_point_type_decimal_digits_003 fixed_point_type;
