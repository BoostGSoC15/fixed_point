...
BOOST_AUTO_TEST_CASE(round_trip_decimal_digits_005)
{
  ...
  // The values range from 0.00001, 0.00002, 0.00003, ... 0.50000.
  for(count = UINT32_C(1); ((count < UINT32_C(50000)) && b); ++count)
  {
    std::stringstream ss1;
  ...
  BOOST_CHECK_EQUAL(count, UINT32_C(50000));
