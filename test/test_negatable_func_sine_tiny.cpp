...
//! \file
//!\brief Tests for the trigonometric sine function of (fixed_point) for a tiny digit range.

#include <cmath>

#define BOOST_TEST_MODULE test_negatable_func_sine_tiny
#define BOOST_LIB_DIAGNOSTIC

#include <boost/fixed_point/fixed_point.hpp>
#include <boost/test/included/unit_test.hpp>

BOOST_AUTO_TEST_CASE(test_negatable_func_sine_tiny)
{
