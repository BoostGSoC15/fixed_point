...
//! \file
//!\brief Tests round-trip for fixed_point negatable with 50 decimal digits.

#define BOOST_TEST_MODULE test_negatable_round_trip_digits10_050
...
BOOST_AUTO_TEST_CASE(test_negatable_round_trip_digits10_050)
{
  using local::fixed_point_type;
